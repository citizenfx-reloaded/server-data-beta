local function getPickupType(i)
	...
	local w = GenerateRandomIntInRange(5, 17)
...
local function createPickup(ptype, etype, unk, x, y, z)
	if ptype == 30 then
		CreatePickupWithAmmo(0x972daa10, etype, 0, x, y, z)
	elseif ptype == 31 then
		CreatePickupWithAmmo(0x3fc62578, etype, 0, x, y, z)
	else
		CreatePickupWithAmmo(GetWeapontypeModel(ptype), etype, 60, x, y, z)
	end
end
...
local function createPickups()
	Citizen.Trace("creating algo pickups\n")
...
RegisterNetEvent('createGunPickups')
